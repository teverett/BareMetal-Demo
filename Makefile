...
apps: $(OBJDIR)/hello.app \
 ...
 $(OBJDIR)/bareMetalNetwork.o \
 $(OBJDIR)/bareMetalConsole.o \
 $(OBJDIR)/new.o \
...
$(OBJDIR)/crt0.o: objdir $(SRCDIR)/crt0.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/crt0.o $(SRCDIR)/crt0.c -I $(SRCDIR)

$(OBJDIR)/libBareMetal.o: objdir $(SRCDIR)/libBareMetal.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/libBareMetal.o $(SRCDIR)/libBareMetal.c -I $(SRCDIR)

$(OBJDIR)/helloc.app: objdir $(SRCDIR)/helloc.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/helloc.o $(SRCDIR)/helloc.c -I $(SRCDIR)
...
$(OBJDIR)/uitestc.app: objdir $(SRCDIR)/uitestc.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/uitestc.o $(SRCDIR)/uitestc.c -I $(SRCDIR)
...
$(OBJDIR)/raytrace.app: objdir $(SRCDIR)/raytrace.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/raytrace.o $(SRCDIR)/raytrace.c -I $(SRCDIR)
...
$(OBJDIR)/gavare.app: objdir $(SRCDIR)/gavare.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/gavare.o $(SRCDIR)/gavare.c -I $(SRCDIR)
...
$(OBJDIR)/minIP.app: objdir $(SRCDIR)/minIP.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/minIP.o $(SRCDIR)/minIP.c -I $(SRCDIR)
...
$(OBJDIR)/cube3d.app: objdir $(SRCDIR)/cube3d.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/cube3d.o $(SRCDIR)/cube3d.c -I $(SRCDIR)
...
$(OBJDIR)/color-plasma.app: objdir $(SRCDIR)/color-plasma.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/color-plasma.o $(SRCDIR)/color-plasma.c -I $(SRCDIR)
...
$(OBJDIR)/3d-model-loader.app: objdir $(SRCDIR)/3d-model-loader/3d-model-loader.c
	$(CC) $(CFLAGS) -o $(OBJDIR)/3d-model-loader.o $(SRCDIR)/3d-model-loader/3d-model-loader.c -I $(SRCDIR)
	$(LD) $(LDFLAGS) -T $(SRCDIR)/c.ld -o $(OBJDIR)/3d-model-loader.app $(OBJDIR)/crt0.o $(OBJDIR)/libBareMetal.o $(OBJDIR)/3d-model-loader.o

$(OBJDIR)/bareMetalNetwork.o: objdir $(SRCDIR)/cpp/bareMetalNetwork.cpp
	$(CC) $(CFLAGS) -o $(OBJDIR)/bareMetalNetwork.o $(SRCDIR)/cpp/bareMetalNetwork.cpp -I $(SRCDIR)

$(OBJDIR)/bareMetalConsole.o: objdir $(SRCDIR)/cpp/bareMetalConsole.cpp
	$(CC) $(CFLAGS) -o $(OBJDIR)/bareMetalConsole.o $(SRCDIR)/cpp/bareMetalConsole.cpp -I $(SRCDIR)

$(OBJDIR)/new.o: objdir $(SRCDIR)/cpp/new.cpp
	$(CC) $(CFLAGS) -o $(OBJDIR)/new.o $(SRCDIR)/cpp/new.cpp -I $(SRCDIR)
